...
--
-- Host: localhost
-- Generation Time: Nov 13, 2021 at 12:15 AM
...
INSERT INTO `inventory` (`product_id`, `product_name`, `category`, `Unit_price`, `in_stock`, `img`, `Measurement`, `restaurant_id`, `in_stock_limit`) VALUES
(1, 'Tomato', 'Fresh Foods', '2.00', 150, 'no_image', 'kg', 1, 50);
...
INSERT INTO `Menu` (`menu_id`, `name_of_food`, `category_id`, `price`, `img`, `size`, `restaurant_id`) VALUES
...
INSERT INTO `orders` (`order_id`, `bill_no`, `date`, `payment_method`, `waiter_name`, `total_cost`, `stats`, `restaurant_id`, `table_id`, `dine-type`, `user_id`, `sub_total`, `special_notes`) VALUES
(1, '1', '2021-11-02', 'Cash', 'Waiter 1', '20.00', 'Pending', 1, '1', 'Dine-In', 4, '17.00', NULL);
...
INSERT INTO `production_transaction` (`transaction_id`, `Date`, `restaurant_id`, `Quantity`) VALUES
(1, '2021-11-02 00:00:00', 1, 10);
...
--
ALTER TABLE `product_transact_item`
  MODIFY `production_trans_id` int(11) NOT NULL AUTO_INCREMENT;
