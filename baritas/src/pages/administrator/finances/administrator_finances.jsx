...
class AdminFinancePage extends React.Component {
        ...
        return (
          <div class="proda">
            ...
            <div class="optprod">
                <Container>
                    <Row>
                        <Col>  <Link to="/administrator/finances/"><button class="o1 ac">GENERAL</button></Link></Col>
